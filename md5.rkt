...
(library
 ...
 (define (process-block block digest)
   ...
   (let* ((a-offset 0)
          ...
          (c-offset 8)
          (d-offset 12)
          (A (lambda () (bytevector-u32-ref digest a-offset 'big)))
          (B (lambda () (bytevector-u32-ref digest b-offset 'big)))
          (C (lambda () (bytevector-u32-ref digest c-offset 'big)))
          (D (lambda () (bytevector-u32-ref digest d-offset 'big)))
          (AA (A))
          (BB (B))
          (CC (C))
          (DD (D)))
     (begin
       ; round 1
       (bytevector-u32-set! digest a-offset (the-operation (A) (B) (C) (D) 0 7 1 F) 'big)
       (bytevector-u32-set! digest d-offset (the-operation (D) (A) (B) (C) 1 12 2 F) 'big)
       (bytevector-u32-set! digest c-offset (the-operation (C) (D) (A) (B) 2 17 3 F) 'big)
       (bytevector-u32-set! digest b-offset (the-operation (B) (C) (D) (A) 3 22 4 F) 'big)
       (bytevector-u32-set! digest a-offset (the-operation (A) (B) (C) (D) 4 7 5 F) 'big)
       (bytevector-u32-set! digest d-offset (the-operation (D) (A) (B) (C) 5 12 6 F) 'big)
       (bytevector-u32-set! digest c-offset (the-operation (C) (D) (A) (B) 6 17 7 F) 'big)
       (bytevector-u32-set! digest b-offset (the-operation (B) (C) (D) (A) 7 22 8 F) 'big)
       ...
       (bytevector-u32-set! digest b-offset (the-operation (B) (C) (D) (A) 15 22 16 F) 'big)      
       ; round 2
       (bytevector-u32-set! digest a-offset (the-operation (A) (B) (C) (D) 1 5 17 G) 'big)
       (bytevector-u32-set! digest d-offset (the-operation (D) (A) (B) (C) 6 9 18 G) 'big)
       (bytevector-u32-set! digest c-offset (the-operation (C) (D) (A) (B) 11 14 19 G) 'big)
       (bytevector-u32-set! digest b-offset (the-operation (B) (C) (D) (A) 0 20 20 G) 'big)
       (bytevector-u32-set! digest a-offset (the-operation (A) (B) (C) (D) 5 5 21 G) 'big)
       (bytevector-u32-set! digest d-offset (the-operation (D) (A) (B) (C) 10 9 22 G) 'big)
       (bytevector-u32-set! digest c-offset (the-operation (C) (D) (A) (B) 15 14 23 G) 'big)
       (bytevector-u32-set! digest b-offset (the-operation (B) (C) (D) (A) 4 20 24 G) 'big)
       ...
       (bytevector-u32-set! digest b-offset (the-operation (B) (C) (D) (A) 12 20 32 G) 'big)
       ; round 3
       (bytevector-u32-set! digest a-offset (the-operation (A) (B) (C) (D) 5 4 33 H) 'big)
       (bytevector-u32-set! digest d-offset (the-operation (D) (A) (B) (C) 8 11 34 H) 'big)
       (bytevector-u32-set! digest c-offset (the-operation (C) (D) (A) (B) 11 16 35 H) 'big)
       (bytevector-u32-set! digest b-offset (the-operation (B) (C) (D) (A) 14 23 36 H) 'big)
       (bytevector-u32-set! digest a-offset (the-operation (A) (B) (C) (D) 1 4 37 H) 'big)
       (bytevector-u32-set! digest d-offset (the-operation (D) (A) (B) (C) 4 11 38 H) 'big)
       (bytevector-u32-set! digest c-offset (the-operation (C) (D) (A) (B) 7 16 39 H) 'big)
       (bytevector-u32-set! digest b-offset (the-operation (B) (C) (D) (A) 10 23 40 H) 'big)
       ...
       (bytevector-u32-set! digest b-offset (the-operation (B) (C) (D) (A) 2 23 48 H) 'big)
       ; round 4
       (bytevector-u32-set! digest a-offset (the-operation (A) (B) (C) (D) 0 6 49 I) 'big)
       (bytevector-u32-set! digest d-offset (the-operation (D) (A) (B) (C) 7 10 50 I) 'big)
       (bytevector-u32-set! digest c-offset (the-operation (C) (D) (A) (B) 14 15 51 I) 'big)
       (bytevector-u32-set! digest b-offset (the-operation (B) (C) (D) (A) 5 21 52 I) 'big)
       (bytevector-u32-set! digest a-offset (the-operation (A) (B) (C) (D) 12 6 53 I) 'big)
       (bytevector-u32-set! digest d-offset (the-operation (D) (A) (B) (C) 3 10 54 I) 'big)
       (bytevector-u32-set! digest c-offset (the-operation (C) (D) (A) (B) 10 15 55 I) 'big)
       (bytevector-u32-set! digest b-offset (the-operation (B) (C) (D) (A) 1 21 56 I) 'big)
       ...
       (bytevector-u32-set! digest b-offset (the-operation (B) (C) (D) (A) 9 21 64 I) 'big)

       (bytevector-u32-set! digest a-offset (u32-sum (A) AA) 'big)
       (bytevector-u32-set! digest b-offset (u32-sum (B) BB) 'big)
       (bytevector-u32-set! digest c-offset (u32-sum (C) CC) 'big)
       (bytevector-u32-set! digest d-offset (u32-sum (D) DD) 'big)
 ...
 (define (make-length message-length)
   (let ((truncated-length (bitwise-and message-length #xffffffffffffffff))
     ...
     (begin
       (bytevector-u64-set! truncated-length-bytes 0 truncated-length 'big)
